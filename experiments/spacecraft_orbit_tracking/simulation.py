...
def simulation(x_true: ArrayLike,
    ...
    return (time,
            ...
            cmd_control_history,
            actual_control_history,
            measurement_history,
            attitude_tracking_error_norm_history,
            omega_tracking_error_norm_history,
            attitude_estimation_error_angle_history,
            omega_estimation_norm_error_history)
