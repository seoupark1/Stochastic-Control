...
def simulation():
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('experiments/lqg/linear_acceleration_lqg/true_vs_estimated.png')
    plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('experiments/lqg/linear_acceleration_lqg/estimation_error.png')
    plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('experiments/lqg/linear_acceleration_lqg/measurement_and_control.png')
    plt.close()
