...
def plot_graphs(results,
    ...
    # tracking error
    plt.subplot(2, 1, 1)
    plt.plot(results['time'], results['attitude_tracking_error_norm_history'])
    plt.xlabel('Time [s]')
    plt.ylabel('Attitude Error [rad]')
    plt.title('Nadir Pointing Attitude Tracking Error')
    plt.grid(True)
    plt.subplot(2, 1, 2)
    plt.plot(results['time'], results['omega_tracking_error_norm_history'])
    plt.xlabel('Time [s]')
    ...
    # estimation error
    plt.subplot(2, 1, 1)
    plt.plot(results['time'], results['attitude_estimation_error_angle_history'])
    plt.xlabel('Time [s]')
    plt.ylabel('Attitude Error [rad]')
    plt.title('Nadir Pointing Attitude Estimation Error')
    plt.grid(True)
    plt.subplot(2, 1, 2)
    plt.plot(results['time'], results['omega_estimation_norm_error_history'])
    plt.xlabel('time [s]')
    plt.ylabel('Angular Velocity Error [rad/s]')
    ...
    # commanded control
    plt.subplot(2, 1, 1)
    plt.plot(results['time'][0:-1], results['actual_control_history'][0], label = 'u_1')
    plt.plot(results['time'][0:-1], results['actual_control_history'][1], label = 'u_2')
    plt.plot(results['time'][0:-1], results['actual_control_history'][2], label = 'u_3')
    plt.xlabel('Time [s]')
    ...
    plt.grid(True)
    plt.subplot(2, 1, 2)
    plt.plot(results['time'][0:-1], np.linalg.norm(results['actual_control_history'], axis = 0))
    plt.xlabel('Time [s]')
    plt.ylabel('Torque [Nm]')
    ...
    # ekf uncertainty
    plt.subplot(2, 1, 1)
    plt.plot(results['time'], results['standard_deviation_P'][0], label = 'mrp_1')
    plt.plot(results['time'], results['standard_deviation_P'][1], label = 'mrp_2')
    plt.plot(results['time'], results['standard_deviation_P'][2], label = 'mrp_3')
    plt.xlabel('Time [s]')
    ...
    plt.grid(True)
    plt.subplot(2, 1, 2)
    plt.plot(results['time'], results['standard_deviation_P'][3], label = 'omega_1')
    plt.plot(results['time'], results['standard_deviation_P'][4], label = 'omega_2')
    plt.plot(results['time'], results['standard_deviation_P'][5], label = 'omega_3')
    plt.xlabel('Time [s]')
    plt.ylabel('Standard Deviation')
