...
def simulation():
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('validations/compensators/ekf_lqr_compensator/results/reference_vs_true_vs_estimated.png')
    plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('validations/compensators/ekf_lqr_compensator/results/estimation_error.png')
    plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('validations/compensators/ekf_lqr_compensator/results/measurement_and_control.png')
    plt.close()
