...
plt.grid(True)
plt.tight_layout()
plt.savefig(f'validations/compensators/ekf_rti_nmpc_compensator/results/tracking_error.png')
plt.close()
...
with open('validations/compensators/ekf_rti_nmpc_compensator/results/rti_nmpc_qp_status.txt', 'w') as file:
    file.write(context)
...
fig.tight_layout()
plt.savefig(f'validations/compensators/ekf_rti_nmpc_compensator/results/commanded_control.png')
plt.close()