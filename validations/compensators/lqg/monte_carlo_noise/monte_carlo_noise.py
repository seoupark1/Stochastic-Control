...
plt.grid(True)
plt.savefig('validations/compensators/lqg/monte_carlo_noise/results/position_regulation_control_relationship.png')
plt.close()
...
plt.grid(True)
plt.savefig('validations/compensators/lqg/monte_carlo_noise/results/velocity_regulation_control_relationship.png')
plt.close()
...
plt.grid(True)
plt.savefig('validations/compensators/lqg/monte_carlo_noise/results/position_estimation_control_relationship.png')
plt.close()
...
plt.grid(True)
plt.savefig('validations/compensators/lqg/monte_carlo_noise/results/velocity_estimation_control_relationship.png')
plt.close()