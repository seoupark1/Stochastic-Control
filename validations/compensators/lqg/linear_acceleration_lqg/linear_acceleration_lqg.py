...
def simulation():
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('validations/compensators/lqg/linear_acceleration_lqg/results/true_vs_estimated.png')
    plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('validations/compensators/lqg/linear_acceleration_lqg/results/estimation_error.png')
    plt.close()
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig('validations/compensators/lqg/linear_acceleration_lqg/results/measurement_and_control.png')
    plt.close()
