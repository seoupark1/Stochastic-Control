...
def get_graph(time,
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('experiments/lyapunov_controller/controller_performance_comparison/' + png_title)
    plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig('experiments/lyapunov_controller/controller_performance_comparison/final_result.png')
plt.close()